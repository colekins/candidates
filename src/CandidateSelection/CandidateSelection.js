...
var isSmallScreen = (document.body.clientWidth < 700 || document.body.clientHeight < 400);

const CandidateSelection = (props) => (
        <div className="candidate-selection">
            <div className={`${((props.selected != null || (isMobile && isSmallScreen)) ? 'horizontal-flow' : '')}`}>
              {

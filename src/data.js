const userData = {
    "results": [{
        ...
        },
        {
            ...
            "issues": {
                "healthcare": "Opposes Medicare for All, but would expand coverage. Would provide a public option in addition to exisintg private market. Supports negotiating drug prices for Medicare’s outpatient prescription drug benefit",
...
const sortedData = userData.results.sort(function(a, b) {
